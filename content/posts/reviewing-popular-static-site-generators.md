...
My lack of experience didn't help either & my initial attempt to do so with [Jekyll][jekyll] failed. So, I jumped ship to [Gatsby][gatsby] & [GitHub Pages][github pages] which didn't work out either! _sighs_. So, I made another quick switch to [Pelican][pelican] & used it to work with some of my first few articles.
